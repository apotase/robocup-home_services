...
from robo_face_compare.srv import *
import rospy
...
# temp.jpg中的照片由摄像头获取
# temp_image = face_recognition.load_image_file('/home/aokaihua/receptionist/src/robo_face_detection/src/temp2.jpg')
# When comparing faces, rosservice should store pics in different places
compare_image_path = '/home/aokaihua/receptionist/src/robo_face_compare/src/compare.jpg'
face_store_path = '/home/aokaihua/receptionist/src/robo_face_detection/src/face_store/'
compare_store_path = '/home/aokaihua/receptionist/src/robo_face_compare/compare_store/'
cut_store_path = '/home/aokaihua/receptionist/src/robo_face_compare/cut_store/'
...
def face_compare_srv():
    ...
    # sub = rospy.Subscriber('/kinect2_down/hd/image_color',Image,
    # callback)
